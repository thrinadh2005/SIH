...
type Page = "overview" | "workflow" | "command" | "optimizer" | "console" | "results" | "fleet" | "commercial" | "swarm" | "edge" | "fuel" | "benchmark" | "compliance" | "notifications" | "health" | "settings"
...
export default function App() {
  ...
  const renderScreen = () => {
    switch (page) {
      ...
      case "workflow":
        return <WorkflowScreen onNavigate={navigate} />
      case "command":
        return <CommandCenter onNavigate={navigate} />
      case "optimizer":
        return <VoyageOptimizer onNavigate={navigate} />
      case "console":
        return <OptimizationConsole onNavigate={navigate} />
      case "results":
        return <OptimizationResults onNavigate={navigate} />
      case "fleet":
        return <FleetManagement onNavigate={navigate} />
      case "commercial":
        return <CommercialEconomics onNavigate={navigate} />
      case "swarm":
        return <SwarmConvoyScreen onNavigate={navigate} />
      case "edge":
        return <EdgeGatewayScreen onNavigate={navigate} />
      case "fuel":
        return <FuelSandbox onNavigate={navigate} />
      case "benchmark":
        return <BenchmarkArena />
      case "compliance":
        return <CIICompliance onNavigate={navigate} />
      case "notifications":
      case "health":
      case "settings":
    ...
    >
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <main
            className="flex-1 min-h-0 overflow-hidden pb-0 lg:pb-0"
